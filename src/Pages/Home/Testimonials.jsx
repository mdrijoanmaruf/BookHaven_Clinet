  ...
  return (
    <div className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center mb-3 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">What Our Readers Say</h2>
        <p className="text-center text-primary-dark mb-12 max-w-2xl mx-auto">Hear from our community of book lovers and readers</p>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial) => (
            <div 
              key={testimonial.id} 
              className="bg-white rounded-lg shadow-md p-8 border border-gray-100 relative hover:shadow-lg transition-shadow duration-300"
            >
              ...
              <div className="text-center mt-12">
                <svg className="w-10 h-10 mx-auto text-gray-300 mb-4" fill="currentColor" viewBox="0 0 24 24">
