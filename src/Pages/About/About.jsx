  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-primary-dark mb-2">Our Team</h2>
            <div className="w-24 h-1 bg-accent mx-auto"></div>
            <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
              Meet the dedicated professionals who make BookHaven possible. Our diverse team brings together expertise in library science, technology, and customer service.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Team Member 1 */}
            <div className="bg-gray-50 rounded-lg overflow-hidden text-center shadow-md transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
              <img 
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-primary-dark">John Doe</h3>
                <p className="text-accent mb-2">Founder & CEO</p>
                <p className="text-gray-600 text-sm">
                  With over 15 years of experience in library management and a passion for literature, John leads our vision for the future.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg overflow-hidden text-center shadow-md transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-primary-dark">Jane Smith</h3>
                <p className="text-accent mb-2">Head Librarian</p>
                <p className="text-gray-600 text-sm">
                  Jane brings her expertise in library science and user experience to ensure our platform meets the needs of readers and libraries alike.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg overflow-hidden text-center shadow-md transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-primary-dark">Michael Johnson</h3>
                <p className="text-accent mb-2">Tech Lead</p>
                <p className="text-gray-600 text-sm">
                  Michael's innovative approach to technology has shaped our platform into the intuitive and powerful tool it is today.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg overflow-hidden text-center shadow-md transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-primary-dark">Sarah Williams</h3>
                <p className="text-accent mb-2">Community Manager</p>
                <p className="text-gray-600 text-sm">
                  Sarah works tirelessly to build and nurture our community, creating events and programs that bring readers together.
                </p>
              </div>
            </div>
          </div>
