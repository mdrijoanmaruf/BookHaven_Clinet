      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">Your one-stop destination for all kinds of books. Explore, borrow, and discover your next favorite read with us.</p>
          </div>

          {/* Quick Links */}
          <div>
            <h3 className="text-primary-dark font-bold text-lg mb-4">Quick Links</h3>
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-gray-600 hover:text-accent transition-colors">Home</Link>
              </li>
              <li>
                <Link to="/all-books" className="text-gray-600 hover:text-accent transition-colors">All Books</Link>
              </li>
              <li>
                <Link to="/add-book" className="text-gray-600 hover:text-accent transition-colors">Add Book</Link>
              </li>
              <li>
                <Link to="/borrowed-books" className="text-gray-600 hover:text-accent transition-colors">Borrowed Books</Link>
              </li>
            </ul>
          </div>
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-primary-dark font-bold text-lg mb-4">Contact Us</h3>
            <p className="text-gray-600 mb-2">Email: info@bookhaven.com</p>
            <p className="text-gray-600 mb-2">Phone: +1 (123) 456-7890</p>
            <p className="text-gray-600">Address: 123 Library St, Book City</p>
          </div>
        </div>
        ...
        <div className="border-t border-gray-100 pt-6 mb-4">
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <a href="https://leetcode.com/u/mdrijoanmaruf/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-gray-100 flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-colors duration-300">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-400 text-xs mt-2">© {new Date().getFullYear()} BookHaven. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
